 ...
 */
@TableName("fuwujindu")
public class FuwujinduEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FuwujinduEntity() {
		
	}
	
	public FuwujinduEntity(T t) {
		try {
	 ...
	 * 设置：服务进度
	 */
	public void setFuwujindu(String fuwujindu) {
		this.fuwujindu = fuwujindu;
	}
	/**
	 * 获取：服务进度
	 */
	public String getFuwujindu() {
		return fuwujindu;
	}
	/**
	 * 设置：健康状况
