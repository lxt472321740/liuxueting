<template>
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="服务编号" prop="fuwubianhao">
					<el-input v-model="ruleForm.fuwubianhao" placeholder="服务编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.fuwubianhao" label="服务编号" prop="fuwubianhao">
					<el-input v-model="ruleForm.fuwubianhao" placeholder="服务编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="项目等级" prop="xiangmudengji">
					<el-select :disabled="ro.xiangmudengji" v-model="ruleForm.xiangmudengji" placeholder="请选择项目等级" >
						<el-option
							v-for="(item,index) in xiangmudengjiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="项目等级" prop="xiangmudengji">
					<el-input v-model="ruleForm.xiangmudengji"
						placeholder="项目等级" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="服务介绍" prop="fuwujieshao">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.fuwujieshao" label="服务介绍" prop="fuwujieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"1.5","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.fuwujieshao"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xiangmudengji'){
							this.ruleForm.xiangmudengji = obj[o];
							this.ro.xiangmudengji = true;
							continue;
						}
						if(o=='fuwujiage'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fuwujieshao = this.ruleForm.fuwujieshao.replace(reg,'../../../springbootkpvj4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
