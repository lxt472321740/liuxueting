<template>
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="病例编号" prop="binglibianhao">
					<el-input v-model="ruleForm.binglibianhao" placeholder="病例编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.binglibianhao" label="病例编号" prop="binglibianhao">
					<el-input v-model="ruleForm.binglibianhao" placeholder="病例编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="病例名称" prop="binglimingcheng">
					<el-input v-model="ruleForm.binglimingcheng" placeholder="病例名称" clearable  :readonly="ro.binglimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="病例名称" prop="binglimingcheng">
					<el-input v-model="ruleForm.binglimingcheng" placeholder="病例名称" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.binglifujian" label="病例附件" prop="binglifujian">
					<file-upload
						tip="点击上传病例附件"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.binglifujian" label="病例附件" prop="binglifujian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#4662A1","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.binglifujian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.binglifujian" label="病例附件" prop="binglifujian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#4662A1","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small">无</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="入院时间" prop="ruyuanshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.ruyuanshijian" label="入院时间" prop="ruyuanshijian">
					<el-input v-model="ruleForm.ruyuanshijian" placeholder="入院时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="出院时间" prop="chuyuanshijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.chuyuanshijian" 
						type="date"
						:readonly="ro.chuyuanshijian"
						placeholder="出院时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chuyuanshijian" label="出院时间" prop="chuyuanshijian">
					<el-input v-model="ruleForm.chuyuanshijian" placeholder="出院时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="症状" prop="zhengzhuang">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="症状"
					  v-model="ruleForm.zhengzhuang" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.zhengzhuang" label="症状" prop="zhengzhuang">
					<span :style='{"fontSize":"14px","lineHeight":"1.5","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zhengzhuang}}</span>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.ruyuanshijian = this.getCurDate()
		this.ruleForm.chuyuanshijian = this.getCurDate()
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zhengzhuang'){
							this.ruleForm.zhengzhuang = obj[o];
							this.ro.zhengzhuang = true;
							continue;
						}
						if(o=='ruyuanshijian'){
						...
						if(o=='chuyuanshijian'){
							this.ruleForm.chuyuanshijian = obj[o];
							this.ro.chuyuanshijian = true;
							continue;
						}
						if(o=='dengjishijian'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springbootkpvj4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.binglifujian!=null) {
		this.ruleForm.binglifujian = this.ruleForm.binglifujian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    binglifujianUploadChange(fileUrls) {
	    this.ruleForm.binglifujian = fileUrls;
    },
  }
};
</script>
