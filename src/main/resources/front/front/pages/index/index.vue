	...
	<view :style='{"width":"100%","padding":"0 0 64rpx","background":"url(http://codegen.caihongy.cn/20221108/581bb1956ffe4c8182127ca1e196e95e.png) fixed","height":"auto"}'>
		...
		<view class="listBox recommend">
			...
			<view class="title" :style='{"width":"100%","padding":"0 24rpx","boxShadow":"0px 4rpx 12rpx #ccc","margin":"24rpx 0 0 0","background":"radial-gradient(circle, rgba(216,214,246,1) 0%, rgba(204,189,235,1) 24%, rgba(181,191,232,1) 62%, rgba(175,173,228,1) 100%),rgb(216,214,246)"}'>
				<view :style='{"color":"#fff","fontSize":"32rpx","lineHeight":"76rpx"}'>服务信息推荐</view>
			</view>
			...
			<view class="list-box style1" :style='{"padding":"24rpx","margin":"24rpx 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
				<view @tap="onDetailTap('fuwuxinxi',product.id)" v-for="(product,index) in fuwuxinxilist" :key="index" class="list-item" :style='{"boxShadow":"-8rpx 0px 0px rgba(188,188,226,.9)","padding":"16rpx","margin":"0 0 20rpx","backgroundColor":"#ecebf6","borderRadius":"12rpx","width":"48%","height":"auto"}'>
					<view :style='{"padding":"4rpx 20rpx","color":"#333","borderRadius":"8rpx 8rpx 0 0","background":"#fff","width":"100%","lineHeight":"48rpx","fontSize":"28rpx"}' class="list-item-title ">{{product.fuwuxiangmu}}</view>
					<image :style='{"width":"100%","padding":"0","margin":"0","objectFit":"cover","display":"block","height":"300rpx"}' class="list-item-image" mode="aspectFill" v-if="product.fuwufengmian.substring(0,4)=='http'" :src="product.fuwufengmian"></image>
					<image :style='{"width":"100%","padding":"0","margin":"0","objectFit":"cover","display":"block","height":"300rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.fuwufengmian?baseUrl+product.fuwufengmian.split(',')[0]:''"></image>
				</view>
			</view>
		...
		<!-- 新闻资讯 -->
			...
			<view class="title" :style='{"padding":"0 24rpx","boxShadow":"0px 4rpx 12rpx #ccc","margin":"24rpx 0 0 0","background":"radial-gradient(circle, rgba(216,214,246,1) 0%, rgba(204,189,235,1) 24%, rgba(181,191,232,1) 62%, rgba(175,173,228,1) 100%),rgb(216,214,246)","display":"flex","width":"100%","justifyContent":"space-between"}'>
				<view :style='{"color":"#fff","fontSize":"32rpx","lineHeight":"76rpx"}'>公告信息</view>
		...
		<!-- 系统简介 -->
		<view :style='{"padding":"0 24rpx 24rpx","margin":"24rpx 16rpx 0px 16rpx","borderColor":"#afade4","borderRadius":"8rpx","flexWrap":"wrap","background":"#fafafe","borderWidth":"8rpx 2rpx 4rpx 2rpx","display":"flex","width":"calc(100% - 32rpx)","borderStyle":"solid","height":"auto"}'>
		  <view :style='{"padding":"8rpx 0 0 8rpx","margin":"24rpx 48rpx 0 0","borderColor":"#afade4","color":"#333","textAlign":"center","borderWidth":"8rpx 0 0 8rpx","width":"48rpx","fontSize":"48rpx","borderStyle":"solid"}'>{{systemIntroductionDetail.title}}</view>
		  <view :style='{"margin":"24rpx 16rpx 0 32rpx","transform":"rotate(0deg)","color":"#999","textAlign":"center","display":"none","width":"8rpx","fontSize":"32rpx"}'>{{systemIntroductionDetail.subtitle}}</view>
		  <view :style='{"border":"4rpx solid #ccc","padding":"8rpx","margin":"24rpx 0 0 0","flexWrap":"wrap","display":"flex","width":"calc(100% - 108rpx)","height":"360rpx"}'>
		    <img :style='{"width":"100%","margin":"0px","objectFit":"cover","display":"block","height":"100%"}' v-if="systemIntroductionDetail.picture1" :src="baseUrl+systemIntroductionDetail.picture1">
		  ...
		  <view :style='{"padding":"0","margin":"24rpx 0 0 0","color":"rgb(102, 102, 102)","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textIndent":"2em"}' v-html="systemIntroductionDetail.content"></view>
		  <view :style='{"width":"50%","background":"url(http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg) 0% 0% / cover no-repeat","display":"none","height":"160rpx"}' />
		  <view :style='{"width":"50%","background":"url(http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg) 0% 0% / cover no-repeat","display":"none","height":"160rpx"}' />
		</view>
...
<script>
	...
	export default {
		...
		async onShow() {
			...
			// 推荐信息
			res = await this.$api.recommend('fuwuxinxi', {                                              
                page: 1,
                limit: 4
            });
